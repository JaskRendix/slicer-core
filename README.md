...
* Polyline offsetting with multi-fragment fracture handling
* Perimeter generation with concurrent outer and hole shelling
...
Contours are offset inward or outward using Clipper2, automatically handling shape fracturing into multiple fragments. Perimeters are produced by repeated inward offsets, concurrently shelling both outer boundaries and internal holes.
...
* Shape fracturing and multi-fragment validation
* Hole-aware perimeter generation
